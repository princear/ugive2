import {
  ...
  export default class DelDonor extends Component {
    ...
    constructor(props) {
      ...
      render(){
       ...
       // selectedValue={selectedValue}
        style={{ height: 30, fontFamily:"Poppins-Regular",color:'grey', transform: [
            { scaleX: 1 }, 
            { scaleY: .8 },
         ]}}
      ...
      >
        <Picker.Item label="110 Area Start" value="Filter" />
      ...
      <TouchableOpacity style={styles.button}>
                ...
                <TouchableOpacity style={styles.button1}>
                  <Text style={{color:'#fff',fontSize:10,fontFamily:'Poppins-Regular'}}>Help</Text>
                </TouchableOpacity>
